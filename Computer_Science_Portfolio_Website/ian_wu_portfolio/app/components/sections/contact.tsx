...
const Contact = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Open Gmail compose directly (no API route needed for static site)
      ...
      toast({
        title: "Opening Gmail!",
        description: "Thank you for reaching out. Gmail will open to send your message.",
      })
    } catch (error) {
      toast({
        title: "Error opening Gmail",
        description: "Please email me directly at ian.kin.wu@gmail.com",
        variant: "destructive",
      })
    } finally {
              ...
              <CardContent>
                {isSubmitted ? (
                  ...
                  >
                    ...
                    <h3 className="text-2xl font-bold text-gray-900 mb-2">Gmail Opened Successfully!</h3>
                    <p className="text-gray-600 mb-4">
                      Thank you for reaching out. Gmail should have opened with your message ready to send.
                    </p>
                    <Button
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <p className="text-sm text-gray-500 text-center">
                      This form will open Gmail to send your message directly to ian.kin.wu@gmail.com
                    </p>
                  </form>
                )}
              </CardContent>
